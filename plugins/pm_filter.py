    ...
    if query.data.startswith("file"):
        ...
        try:
            msg = await client.send_cached_media(
                ...
                file_id=file_id,
                caption=f'<b>Hai 👋 {query.from_user.mention}</b> 😍\n\n<code> [ᴍᴏᴠɪᴇꜱ-ʜɪɴᴛ] {title}</code>\n\n⚠️ <i>ɴᴏᴛᴇ⚡ : ᴛʜɪꜱ ᴍᴇꜱꜱᴀɢᴇ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏ-ᴅᴇʟᴇᴛᴇᴅ ᴀꜰᴛᴇʀ 5 ᴍɪɴᴜᴛᴇꜱ ᴛᴏ ᴄᴏᴘʏʀɪɢʜᴛ ɪꜱꜱᴜᴇꜱ,... 
                ꜱᴀᴠᴇ ᴛʜɪꜱ ᴏɴ ʏᴏᴜʀ ꜱᴀᴠᴇ ᴍᴇꜱꜱᴀɢᴇꜱ 🆘
                ...!</i>\n\n<i><b>⚡ Powered by {query.message.chat.title}</b></i>',
                protect_content=True if ident == "filep" else False 
            )
            msg1 = await query.message.reply(
                f'<b> Hai 👋 {query.from_user.mention} </b>😍\n\n<b>📫 Your File is Ready</b>\n\n'           
                f'<b>📂 Fɪʟᴇ Nᴀᴍᴇ</b> : <code>[ᴍᴏᴠɪᴇꜱ-ʜɪɴᴛ] {title}</code>\n\n'              
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton('💽ʏᴏᴜʀ ᴍᴏᴠɪᴇ ɪꜱ ʜᴇʀᴇ💽 ', url = msg.link)
                        ],                       
                        [
                            InlineKeyboardButton("⚠️ ꜰɪʟᴇ ꜱᴛᴏʀᴇ ⚠️", url=f'https://t.me/+wfCWSk0FPt8wNDk1')
                        ]
                    ]
                )
            )
